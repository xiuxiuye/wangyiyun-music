...
function Header () {
  ...
  return (
    <div className="wyy-header" style={{ backgroundColor: store.state.skin.primaryColor }}>
      <div className="wyy-header-logo">
        <span className="iconfont icon-wangyiyunyinle wyy-header-logo-icon" style={{ color: store.state.skin.primaryColor }}></span>
