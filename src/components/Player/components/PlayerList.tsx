...
export default function PlayerList ({ opened }: PlayerListProps) {
  ...
  return (
    <div className={`wyy-player-playlist ${store.state.skin.current ? '' : 'wyy-player-playlist-dark'}`}>{}
      ...
      <div className="wyy-player-playlist-content scrollbar" style={{ backgroundColor: store.state.skin.current ? store.state.skin.colors.contentBGColor : 'rgba(48, 50, 54, 0.65)' }}>
